...
packages and binaries. The BG128 decode path uses one A8 scale per 128-value
group. Qwen3.5-4B uses a package generated by the current converter, including
fused gate/up, QKV, and linear-attention input projections.
...
| RWKV7-1.5B mixed W4 | 410.42 / **161.47** | **433.71** / 85.02 | llama 1.06x prefill, mollm 1.90x decode |
...
| Qwen3.5-122B-A10B (SSD offload) | **37.99** / **16.22** † | OOM | runs on a 48GB Mac |

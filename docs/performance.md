...
The Youtu-LLM-2B and Qwen3.5-4B rows were refreshed on 2026-07-26 with the
BG128 decode path using one A8 scale per 128-value group. Qwen3.5-4B uses a
package generated by the current converter, including fused gate/up, QKV, and
linear-attention input projections.
